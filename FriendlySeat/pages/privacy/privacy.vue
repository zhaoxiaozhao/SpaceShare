<template>
	<page-meta :page-style="pageThemeStyle" />
		...
		<view class="doc-section">
			...
			<text class="doc-p">5. 以下信息会在相应功能页面对其他用户可见：您的昵称、头像，以及您主动发布的内容（座位分享信息、换座意向、活动标题/介绍/海报、活动报名、书单的书名/作者/推荐语、场馆交流板的帖子与评论、座位便签、活动留言）。请勿在这些内容中填写或诱导他人提供联系方式、身份信息等个人隐私。</text>
