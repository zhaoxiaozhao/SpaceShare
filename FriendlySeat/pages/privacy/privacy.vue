<template>
	<page-meta :page-style="pageThemeStyle" />
		...
		<view class="doc-section">
			...
			<text class="doc-p">5. 以下信息会在相应功能页面对其他用户可见：您的昵称、头像，以及您主动发布的内容（座位分享信息、换座意向、活动标题/介绍/海报、活动报名）。请勿在这些内容中填写或诱导他人提供联系方式、身份信息等个人隐私。</text>
			<text class="doc-p">6. 您发布的内容不得包含：座位买卖、转让、出租、收费等交易信息，广告导流、联系方式，以及违法或不良信息。平台会对发布内容进行审核（含敏感词过滤与人工审核），并对违规内容予以删除或限制相关功能。</text>
		</view>
