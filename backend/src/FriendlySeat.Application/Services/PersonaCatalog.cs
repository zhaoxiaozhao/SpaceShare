...
public static class PersonaCatalog
{
    ...
    public static readonly IReadOnlyDictionary<string, PersonaType> Types = new Dictionary<string, PersonaType>
    {
        ...
        ["morning_solo_talker"] = new("morning_solo_talker", "早课提问党", "起得早、想得多，喜欢先弄懂再开口。", "想清楚再问，问出来就懂了。", "#2E8B94", "适合共读答疑、线上问题接龙", "谢道韫", "未若柳絮因风起", "你起得早，也更爱追根问底。"),
        ["morning_solo_host"] = new("morning_solo_host", "晨间规划师", "早起、有计划，喜欢把一天先排明白。", "计划写下来的那一刻，就已经开始做了。", "#C98A3D", "适合长期备考、每周复盘小组", "武则天", "明朝游上苑，火速报春知", "你习惯先把一天安排好，再动手。"),
        // ===== 晨 · 结伴 =====
        ...
        ["morning_group_talker"] = new("morning_group_talker", "早茶辩论队", "早上就话多，边吃边把一个话题聊开。", "一个观点聊开心了，一天都顺。", "#57AFB8", "适合读书会、话题早餐局", "卓文君", "愿得一心人，白头不相离", "你早上就话多，聊起喜欢的事尤其停不下来。"),
        ["morning_group_host"] = new("morning_group_host", "晨光召集人", "早起、能聊，常常是那个把人聚起来的人。", "只要我先开个头，大家就都来了。", "#DBA968", "适合组织晨间共学、活动发起", "秋瑾", "身不得，男儿列；心却比，男儿烈", "你总能站出来，把大家聚到一起。"),
        // ===== 夜 · 独行 =====
        ["night_solo_immerser"] = new("night_solo_immerser", "深夜码农", "越晚越清醒，一个人也能沉浸很久。", "夜一安静下来，效率就上来了。", "#5B6E8C", "适合熬夜冲刺、远程各自自习", "李商隐", "何当共剪西窗烛，却话巴山夜雨时", "夜深人静时，你和细节较劲得最久。"),
        ...
        ["night_group_host"] = new("night_group_host", "夜谈主持人", "夜里把大家聚起来，什么都聊一点。", "夜里的话，往往最真。", "#6BAF8B", "适合线上夜谈、活动收尾复盘", "上官婉儿", "叶下洞庭初，思君万里余", "你负责把话题接住，让每个人都聊得开。"),
    };
